...
?>
    <div style="display: flex; flex-direction: column; grid-gap: 17px">
        ...
        <div style="display: flex; grid-gap: 17px">
            ...
            <div>
                <p style="margin: 0"><a style="font-family: 'Marcellus'; font-style: normal; font-weight: 400; font-size: 14px; line-height: 16px; color: #242424; margin: 0; text-decoration: none" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></p>
